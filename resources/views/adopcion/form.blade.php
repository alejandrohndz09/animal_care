                        ...
                        <div class="card  mb-4" style="border:none; padding-bottom: 25px !important; width: 100%">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="inputContainer">
                                            <select id="tamanioHogar" name="tamanioHogar"
                                                data-selected="{{ isset($animal) ? $animal->idRaza : old('tamanioHogar') }}"
                                                class="inputField">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="inputContainer">
                                            <label class="inputFieldLabel" autocomplete="off" for="direccion">Cantidad de
                                                miembros que lo habitan:*</label>
                                            <i class="inputFieldIcon fas fa-users"></i>
                                            <input min="1" step="1"
                                                value="{{ isset($AlbergueEdit) ? old('direccion', $AlbergueEdit->direccion) : old('direccion', '1') }}"
                                                class="inputField" type="number" name="direccion">
                                            @error('direccion')
                                                <small style="color:red">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="inputContainer">
                                            ...
                                            <div style="padding: 3px 15px">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="companiaAnimal"
                                                        id="inlineRadio1" value="Sí"
                                                        {{ (isset($animal) && old('companiaAnimal', $animal->companiaAnimal) == 'Sí') || old('companiaAnimal') == 'Sí' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="Sí">Sí</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="companiaAnimal"
                                                        id="inlineRadio2" value="No"
                                                        {{ isset($animal) ? (old('companiaAnimal', $animal->companiaAnimal) == 'No' ? 'checked' : '') : (old('companiaAnimal') == 'No' ? 'checked' : '') }}>
                                    ...
                                    <div class="col-xl-7">
                                        <div class="d-flex  align-items-center">
                                            ...
                                            <input placeholder="Ej. Calle Principal #123, Ciudad" type="number"
                                                step="1"
                                                value="{{ isset($AlbergueEdit) ? old('direccion', $AlbergueEdit->direccion) : old('direccion', '1') }}"
                                                class="inputField w-100" min="1" name="cantAnimal">
                                        </div>
                                    </div>
                                </div>
