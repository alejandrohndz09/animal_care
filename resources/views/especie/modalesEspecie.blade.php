...
<!-- Modal de ayuda -->
<div class="modal fade" id="ayudaEspecie" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center">
            <div class="modal-header">
            ...
            <div class="modal-body text-center">
                ...
                <p> °En la tabla que muestra las especies ya registradas con las opciones de editar y eliminar también muestra el modulo para registrar una nueva especie.. </p>
                <p></p>
              <p>°Cuando se selecciona la opción Editar el módulo de registrar cambia a Modificar.</p>
                 <img src="img/editar.png" alt="Descripción de la imagen" class="img-fluid">-->
                <p></p>
