...
<body>
    <div class="container">
        ...
        <div>
            ...
            <span class="info-value">{{ $albergue->idAlvergue }}</span>
        </div>

        <div>
            <span class="info-label">Dirección:</span>
            <span class="info-value">{{ $albergue->direccion }}</span>
        </div>
        <div>
            <span class="info-label">Miembro a cargo:</span>
            <span class="info-value">{{ $albergue->miembro->nombres . ' ' . $albergue->miembro->apellidos }}</span>
        </div>
        <div>
            <span class="info-label">Animales albergados:</span>
            <span class="info-value">{{ count($albergue->expedientes) }}</span>
        </div>
