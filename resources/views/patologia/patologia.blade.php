                ...
                <div class="col-xl-7">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div
                                                ...
                                                <a id="btnmodificar" href="{{ url('patologia/' . $p->idPatologia . '/edit') }}"
                                                    type="button" class="button button-blue" data-id="{{ $p->idPatologia }}"
                    ...
                    <div class="col-xl-5">
                        <div class="card  mb-4" style="border:none; padding-bottom: 25px !important; width: 100%">
                            ...
                            <form action="{{ isset($patologiaEdit) ? url('patologia/update/' . $patologiaEdit->idPatologia) : '' }}"
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="inputContainer">
                                            <label class="inputFieldLabel" autocomplete="off" for="patologia">Patologia</label>
                                            <i class="inputFieldIcon fas fa-syringe"></i>
                                            <input placeholder="patologia"
                                                value="{{ isset($patologiaEdit) ? $patologiaEdit->patologia : old('patologia') }}"
                                                class="inputField" name="patologia">
                                            @error('patologia')
