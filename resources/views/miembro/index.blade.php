                    ...
                    @else
                        ...
                        <form action="{{ route('miembros.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="inputContainer">
                                        <input name="nombres" value="{{old('nombres')}}" class="inputField" placeholder="Nombres" type="text"
                                            autocomplete="off">
                                        <label class="inputFieldLabel" for="nombre">Nombres del miembro</label>
                                        <i class="inputFieldIcon fas fa-user"></i>
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="inputContainer">
                                        <input name="apellidos" value="{{old('apellidos')}}" class="inputField" autocomplete="off"
                                            placeholder="Apellidos" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="inputContainer">
                                <input class="inputField"  value="{{old('correo')}}" name="correo" autocomplete="off" placeholder="Correo"
                                    type="email">
                                <label class="inputFieldLabel" for="fecha">Correo</label>
                                <i class="inputFieldIcon fas fa-envelope"></i>
