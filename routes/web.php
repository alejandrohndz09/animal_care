...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/animal/DarAlta/{id}', 'App\Http\Controllers\AnimalControlador@alta');
    ...
    Route::get('miembro/DarBaja/{id}', [MiembroController::class, 'DarBaja']);
    Route::get('miembro/destroy/{id}', [MiembroController::class, 'destroy'])->name('miembros.destroy');
    ...
    Route::put('/adopcion/update/{id}', 'App\Http\Controllers\AdopcionController@update');
    ...
    Route::get('/darBaja/{id}', 'App\Http\Controllers\DonanteController@DarBaja');
    Route::get('/donantes/Alta/{id}', 'App\Http\Controllers\DonanteController@DarAlta');
    Route::get('/destroyDonante/{id}', 'App\Http\Controllers\DonanteController@destroy');
    Route::put('/inventario/donantes/update/{id}', 'App\Http\Controllers\DonanteController@update');
    Route::get('/inventario/donantes/donantes/telefonos/{id}', 'App\Http\Controllers\DonanteController@ObtenerTelefonos');
